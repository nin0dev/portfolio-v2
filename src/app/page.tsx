      ...
      <main className="mb-20">
        <div>
          ...
          <h3 className="text-xl">
            French & Canadian based in Bordeaux, France. <br/> I am a Web enthusiast, specializing in development.
          </h3>
          <br/>
          <a href="/contact">
            <svg className="inline mr-2" width="35" height="8" viewBox="0 0 35 8" fill="none" xmlns="http://www.w3.org/2000/svg"          >
