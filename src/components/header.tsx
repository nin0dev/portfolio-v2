  ...
  return (
    <nav className="bg-[hsla(0,100%,100%,.9)] backdrop-blur-sm	border-y border-[#eaeaea] bottom-0 right-0 left-0 flex fixed justify-between py-5 px-5 z-50 lg:justify-between">
      ...
      <ul
        className={`${
          open
            ? 'flex-col absolute bottom-0 left-0 mb-16 w-full bg-[hsla(0,100%,100%,.9)] backdrop-blur-sm	border-y border-[#eaeaea] py-5 md:hidden'
            : 'hidden'
        }`}
      >
        <li className="px-5 pb-4 font-normal">
          <Link href="/">Home</Link>
        </li>
        <li className="px-5 pb-4 font-normal">
          <Link href="#projects" scroll={false}>
